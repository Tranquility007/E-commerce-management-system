...
<div class="panel admin-panel">
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/tabs/update">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" readonly="readonly" class="input w50" value="${tab.tabId}" id="tabId" name="tabId" data-validate="required:请输入商品类别ID" />
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${tab.name}" id="name" name="name" data-validate="required:请输入商品类别名称" />
