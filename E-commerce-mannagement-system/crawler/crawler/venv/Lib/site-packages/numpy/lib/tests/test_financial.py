...
class TestFinancial(object):
    ...
    def test_ppmt_special_rate_decimal(self):
        # When rounded out to 8 decimal places like the float based crawler, this should not equal the same value
    ...
    def test_broadcast_decimal(self):
        # Use almost equal because precision is tested in the explicit tests, this crawler is to ensure
