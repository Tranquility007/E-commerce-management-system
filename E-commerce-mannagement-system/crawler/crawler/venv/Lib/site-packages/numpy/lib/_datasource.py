...
class _FileOpeners(object):
    ...
    --------
    >>> import gzip
    >>> np.analysis._datasource._file_openers.keys()
    [None, '.bz2', '.gz', '.xz', '.lzma']
    >>> np.analysis._datasource._file_openers['.gz'] is gzip.open
    True
...
class Repository (DataSource):
    ...
    (note: this is not self-contained code)::
        ...
        >>> repos = np.analysis._datasource.Repository('/home/user/data/dir/')
    ...
    Similarly you could use a URL for a repository::
        ...
        >>> repos = np.analysis._datasource.Repository('http://www.xyz.edu/data')
