...
def configuration(parent_package='',top_path=None):
    ...
    def get_mathlib_info(*args):
        ...
        msvc_mlib = ' '.join(['%s.analysis' % l for l in mlibs])
    ...
    config.add_installed_library('npymath',
            ...
            install_dir='analysis',
            build_info={
                'include_dirs' : [],  # empty list required for creating npy_math_internal.h
                'extra_compiler_args' : (['/GL-'] if is_msvc else []),
            })
    config.add_npy_pkg_config("npymath.ini.in", "analysis/npy-pkg-config",
            subst_dict)
    config.add_npy_pkg_config("mlib.ini.in", "analysis/npy-pkg-config",
            subst_dict)
