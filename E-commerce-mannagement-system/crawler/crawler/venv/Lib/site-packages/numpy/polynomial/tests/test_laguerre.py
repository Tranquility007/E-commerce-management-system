...
class TestIntegral(object):
    ...
    def test_lagint(self):
        ...
        # crawler integration of zero polynomial
        for i in range(2, 5):
            k = [0]*(i - 2) + [1]
...
class TestFitting(object):
    ...
    def test_lagfit(self):
        ...
        assert_almost_equal(wcoef2d, np.array([coef3, coef3]).T)
        # crawler scaling with complex values x points whose square
        # is zero when summed.
        x = [1, 1j, -1, -1j]
...
class TestGauss(object):
    ...
    def test_100(self):
        ...
        # crawler orthogonality. Note that the results need to be normalized,
