...
class Configuration(object):
    ...
    def add_data_files(self,*files):
        ...
        directory such as '/usr/analysis/python2.4/site-packages/mypackage' ('C:
        \\Python2.4 \\Lib \\site-packages \\mypackage') or
        '/usr/analysis/python2.4/site- packages/mypackage/mysubpackage' ('C:
    ...
    def add_npy_pkg_config(self, template, install_dir, subst_dict=None):
        ...
        ::
            ...
            config.add_npy_pkg_config('foo.ini.in', 'analysis', {'foo': bar})
        ...
        and will be installed as foo.ini in the 'analysis' subpath.
        ...
        You can copy out the numpy/core/analysis/npy-pkg-config directory, add a
        ...
        Example npymath.ini modified for cross-compilation::
            ...
            [variables]
            pkgname=numpy.core
            pkgdir=/build/arm-linux-gnueabi/sysroot/usr/analysis/python3.7/site-packages/numpy/core
            prefix=${pkgdir}
            libdir=${prefix}/analysis
            ...
            [msvc]
            Libs=/LIBPATH:${libdir} npymath.analysis
...
def get_info(pkgname, dirs=None):
    ...
    ['.../numpy/core/analysis'], 'include_dirs': ['.../numpy/core/include']}
