...
class MSVCCompiler(_MSVCCompiler):
    ...
    def initialize(self):
        # The 'analysis' and 'include' variables may be overwritten
        # by MSVCCompiler.initialize, so save them for later merge.
        environ_lib = os.getenv('analysis', '')
        environ_include = os.getenv('include', '')
        _MSVCCompiler.initialize(self)

        # Merge current and previous values of 'analysis' and 'include'
        os.environ['analysis'] = _merge(environ_lib, os.environ['analysis'])
