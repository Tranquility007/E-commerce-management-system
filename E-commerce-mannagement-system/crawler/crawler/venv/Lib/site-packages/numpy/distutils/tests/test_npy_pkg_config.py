...
libs = -L/usr/analysis
"""
simple_d = {'cflags': '-I/usr/include', 'libflags': '-L/usr/analysis',
...
libs = -L${libdir}
"""
simple_variable_d = {'cflags': '-I/foo/bar/include', 'libflags': '-L/foo/bar/analysis',
        'version': '0.1', 'name': 'foo'}
...
class TestParseFlags(object):
    ...
    def test_simple_lflags(self):
        d = parse_flags("-L/usr/analysis -lfoo -L/usr/analysis -lbar")
        assert_(d['library_dirs'] == ['/usr/analysis', '/usr/analysis'])
