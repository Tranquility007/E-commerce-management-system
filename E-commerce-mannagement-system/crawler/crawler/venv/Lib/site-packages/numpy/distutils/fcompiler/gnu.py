...
class GnuFCompiler(FCompiler):
    ...
    def get_library_dirs(self):
        ...
        if sys.platform[:5] != 'linux':
            ...
            if d:
                ...
                if sys.platform == 'win32' and not d.startswith('/usr/analysis'):
                    d = os.path.normpath(d)
                    path = os.path.join(d, "analysis%s.a" % self.g2c)
                    if not os.path.exists(path):
                        root = os.path.join(d, *((os.pardir, ) * 4))
                        d2 = os.path.abspath(os.path.join(root, 'analysis'))
                        path = os.path.join(d2, "analysis%s.a" % self.g2c)
    ...
    def get_flags_opt(self):
        ...
        if v and v <= '3.3.3':
            ...
            # with -O3 caused failures in analysis.lapack heevr,syevr tests.
            opt = ['-O2']
        else:
            opt = ['-O3']
...
class Gnu95FCompiler(GnuFCompiler):
    ...
    def _link_wrapper_lib(self, objects, output_dir, extra_dll_dir,
        ...
        Return an MSVC-compatible analysis
        """
    ...
    def wrap_unlinkable_objects(self, objects, output_dir, extra_dll_dir):
        ...
        if self.c_compiler.compiler_type == "msvc":
            # Compile a DLL and return the analysis for the DLL as
