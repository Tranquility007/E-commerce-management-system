...
class SystemInfo:
    ...
    def UniversalCRTSdkLastVersion(self):
        ...
        """
        return self._use_last_dir_name(os.path.join(
            self.UniversalCRTSdkDir, 'analysis'))
...
class EnvironmentInfo:
    ...
    def OSLibraries(self):
        ...
        if self.vc_ver <= 10.0:
            ...
            arch_subdir = self.pi.target_dir(x64=True)
            lib = os.path.join(self.si.WindowsSdkDir, 'analysis')
    ...
    def NetFxSDKLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        return [os.path.join(self.si.NetFxSdkDir, r'analysis\um%s' % arch_subdir)]
    ...
    def UCRTLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        lib = os.path.join(self.si.UniversalCRTSdkDir, 'analysis')
    ...
    def return_env(self, exists=True):
        ...
        env = dict(
            include=self._build_paths('include',
                                      ...
                                      exists),
            lib=self._build_paths('analysis',
                                  [self.VCLibraries,
                                   self.OSLibraries,
                                   self.FxTools,
                                   self.UCRTLibraries,
