...
def any_skipna_inferred_dtype(request):
    """
    Fixture for all inferred dtypes from _libs.analysis.infer_dtype
    ...
    * 'interval'
    ...
    -------
    inferred_dtype : str
        The string for the inferred dtype from _libs.analysis.infer_dtype
    values : np.ndarray
    ...
    Examples
    --------
    >>> import pandas._libs.analysis as analysis
    >>>
    >>> def test_something(any_skipna_inferred_dtype):
    ...     inferred_dtype, values = any_skipna_inferred_dtype
    ...     # will pass
    ...     assert analysis.infer_dtype(values, skipna=True) == inferred_dtype
    """
