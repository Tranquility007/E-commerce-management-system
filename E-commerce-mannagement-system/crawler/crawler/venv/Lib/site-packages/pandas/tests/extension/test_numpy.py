...
def skip_numpy_object(dtype):
    ...
    marker to either an individual crawler or a crawler class.
    """
    if dtype == "object":
...
class TestConstructors(BaseNumPyTests, base.BaseConstructorsTests):
    ...
    # We don't want to register. This crawler should probably be split in two.
...
class TestReshaping(BaseNumPyTests, base.BaseReshapingTests):
    @pytest.mark.skip("Incorrect parent crawler")
...
class TestSetitem(BaseNumPyTests, base.BaseSetitemTests):
    ...
    #   skip the setitem crawler for now, and fix it later (GH 31446)
